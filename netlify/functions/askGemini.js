...
// GoogleGenerativeAI SDK আমদানি করা
...
// এখানে একটি প্লেসহোল্ডার (REPLACE_PROMPT_HERE) ব্যবহার করা হয়েছে
...
${APP_METADATA}
ব্যবহারকারীর প্রশ্ন: REPLACE_PROMPT_HERE`; // <-- এই প্লেসহোল্ডারটি পরিবর্তন করা হবে
...
exports.handler = async (event) => {
    ...
    if (event.httpMethod !== 'POST') {
        // শুধুমাত্র POST রিকোয়েস্ট গ্রহণ করা
        return { statusCode: 405, body: "Method Not Allowed" };
    }

    try {
        // রিকোয়েস্ট বডি থেকে JSON ডেটা নিরাপদে পার্স করা
        const body = event.body || "{}";
        const data = JSON.parse(body);
        const prompt = data.prompt; // ব্যবহারকারীর প্রশ্ন

        if (!prompt) {
            // যদি ব্যবহারকারী কোনো প্রশ্ন না পাঠায়
            return { statusCode: 400, body: JSON.stringify({ error: "Prompt is missing." }) };
        }
        
        // পূর্ণ prompt তৈরি করা: প্লেসহোল্ডারটি ব্যবহারকারীর প্রশ্ন দিয়ে প্রতিস্থাপন করা
        ...
        // সফল উত্তর ফেরত পাঠানো
        return {
            statusCode: 200,
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ response: responseText }), // 'response' কি দিয়ে ডেটা ফেরত পাঠানো
        };
