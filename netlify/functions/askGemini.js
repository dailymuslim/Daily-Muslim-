...
// এখানে একটি প্লেসহোল্ডার (REPLACE_PROMPT_HERE) ব্যবহার করা হয়েছে
...
exports.handler = async (event) => {
    ...
    if (event.httpMethod !== 'POST') {
        // শুধুমাত্র POST রিকোয়েস্ট গ্রহণ করা
    ...
    try {
        ...
        // পূর্ণ prompt তৈরি করা: প্লেসহোল্ডারটি ব্যবহারকারীর প্রশ্ন দিয়ে প্রতিস্থাপন করা
        ...
        return {
            ...
            body: JSON.stringify({ response: responseText }), // 'response' কি দিয়ে ডেটা ফেরত পাঠানো
        };
